...
{{< persons "Команда" >}}
  ...
  {{< /person >}}
  {{< person "14" "/images/team/angira_kekteeva.webp" "Ангира Кектеева" "Инженер-Программист" >}}
    <ul>
  ...
  {{< person "18" "/images/team/oleg_kulachenko.webp" "Олег Кулаченко" "QA Инженер" >}}
    <ul>
      ...
      <li>Работал главным инженером-программистом в Yadro и старшим инженером по контролю качества в Dell EMC</li>
    </ul>
  {{< /person >}}
{{< /persons >}}
