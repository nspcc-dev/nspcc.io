...
{{< persons "Команда" >}}
  ...
  {{< /person >}}
  {{< person "24" "/images/team/tural_devrishev.webp" "Турал Девришев" "Инженер-программист" >}}
    <ul>
      <li>Бакалавр Программирования и Информационных Технологий (Санкт-Петербургский Государственный Университет)</li>
      <li>Работал над проектом по детектированию патологий легких на рентгеновских снимках для ООО "Виста"</li>
    </ul>
  {{< /person >}}
{{< /persons >}}
...
{{< roadmap "Дорожная карта" >}}
  {{< roadmap_item "left" "Q3 2025" "Erasure coding" >}}
    <ul>
      ...
      <li>Переработка модели токенов для поддержки новых сценариев применения</li>
      <li>Динамическое время блока</li>
      <li>Квотирование</li>
    </ul>
  {{< /roadmap_item >}}
  {{< roadmap_item "right" "Q2 2025" "Аккаунты N3 в NeoFS, NUMA" >}}
    <ul>
      <li>Полная поддержка аккаунтов N3 в NeoFS</li>
      <li>Ускорение работы на платформах с NUMA</li>
      <li>Синхронизация цепочек из снимков состояний, хранимых в NeoFS</li>
    </ul>
  {{< /roadmap_item >}}
  {{< roadmap_item "left" "Q1 2025" "Быстрый поиск, продолжение метаданных" >}}
    <ul>
      ...
      <li>Переработка S3 для удаления экспериментальных зависимостей</li>
      <li>Переход к односекундным блокам во всех сетях</li>
