...
{{< roadmap "Дорожная карта" >}}
  {{< roadmap_item "right" "Q4 2023" "Погружение в метаданные" >}}
    <ul>
      <li>Прототипирование новой системы обработки метаданных</li>
      <li>Улучшение скоростных характеристик</li>
      <li>Полная интеграция управления контрактами</li>
      <li>Расширение протокола NeoFS для больших объектов и управления доступом</li>
      <li>Реализация расширенных типов данных NEP-14</li>
